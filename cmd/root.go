...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.benchy.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".benchy") // name of config file (without extension)
